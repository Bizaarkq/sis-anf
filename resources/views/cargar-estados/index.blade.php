                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row mb-3">
                                            <label for="efectivoEq"
                                                ...
                                                equivalente</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="efectivoEq" name="1"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="accxc"
                                                ...
                                                cobrar</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="accxc" name="2" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="prestamos"
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="prestamos" name="3" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="deudores"
                                                ...
                                                varios</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="deudores" name="4" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="pagosAnt"
                                                ...
                                                anticipados</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="pagosAnt" name="5" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="pagosCuenta"
                                                ...
                                                cuenta</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="pagosCuenta" name="6"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="credito"
                                                ...
                                                IVA</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="credito" name="7"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="inventario" name="8"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="totalActivosCorrientes"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="propiedad" name="10"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="deprec"
                                                ...
                                                acumulada</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="deprec" name="11"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="seguros" name="12"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="intangibles" name="13"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="depositos"
                                                ...
                                                garantía</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="depositos" name="14"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="totalActivosNoCorrientes"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="totalActivos" name="16"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="proveedores" name="17"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="acreedores" name="18"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="retenciones" name="19"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="impuestosxpagar"
                                                        ...
                                                        por pagar</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="impuestosxpagar" name="20"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="provision"
                                                        ...
                                                        laboral</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="provision" name="21"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="prestamoscortoplazo"
                                                        ...
                                                        a corto plazo</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="prestamoscortoplazo"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="totalPasivosCorrientes"
                                                ...
                                                <div class="row mb-3">
                                                    <label for="prestamoslargoplazo"
                                                        ...
                                                        a largo plazo</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="prestamoslargoplazo"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="totalPasivosNoCorrientes"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="totalPasivos" name="26"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="capitalsocial" class="col-sm-9 col-form-label">Capital
                                                        social</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="capitalsocial" name="27"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="reservas" name="28"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="utilidades" class="col-sm-9 col-form-label">Utilidades no
                                                        distribuidas</label>
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="utilidades" name="29"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="utilidadejercicio"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="totalPatrimonio" name="31"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input  type="number" step="0.01" id="totalPasivoPatrimonio"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="ingresos" name="33"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="costoventas" name="34"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="utilidadbruta" name="35"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="gastosoperacion"
                                                ...
                                                operación</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="gastosoperacion" name="36"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="gastosadmin" name="37"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="gastosmercadeo"
                                                ...
                                                mercadeo</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="gastosmercadeo" name="38"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="gastosfinan" name="39"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="utilidadoperacion"
                                                ...
                                                operación</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="utilidadoperacion" name="40"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="otrosingresos" name="41"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="utilidadimpuesto" name="42"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="reservalegal" class="col-sm-9 col-form-label estado-resultado">(-)
                                                Reserva legal</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="reservalegal" name="43"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="utilidadantesimpuesto" class="col-sm-9 col-form-label estado-resultado">(=)
                                                Utilidad antes de Impuestos</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="utilidadantesimpuesto" name="46"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="impuestorenta"
                                                ...
                                                renta</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="impuestorenta" name="44"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="utilidadneta" class="col-sm-9 col-form-label estado-resultado">(=)
                                                Utilidad neta</label>
                                            <div class="col-sm-3">
                                                <input  type="number" step="0.01" id="utilidadneta" name="45"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
